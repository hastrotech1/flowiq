...
export default function StatementCard({
  ...
  const periodText = statement.periodStart && statement.periodEnd
          ...
          {editing ? (
                ...
                {STATEMENT_COLORS.map(({ value }) => (
                  <button
                    ...
                    className={cn(
                      ...
                      editColor === value ? 'border-gray-700 scale-110' : 'border-transparent',
                    )}
            ...
            <>
              ...
              <div className="flex flex-wrap gap-x-4 gap-y-1 mt-2">
                ...
                <span className="text-xs text-data-secondary">{periodText}</span>
                {totalDebits > 0 && (
        ...
        {!editing && (
          <div className="flex items-center gap-1 shrink-0">
            ...
            <button
              ...
              aria-label={isActive ? 'Exclude from analysis' : 'Include in analysis'}
